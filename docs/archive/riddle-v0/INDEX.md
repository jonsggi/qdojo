# Archived riddle-v0 documentation

Snapshot of the repository documentation immediately before the combat pivot
...
as a new combat onboarding flow.

- [Legacy README](README.md)
- [Riddle specification](docs/spec.md)
- [Protocol](docs/protocol.md)
- [API](docs/api.md)
- [Roadmap](docs/roadmap.md)
- [Product decisions](docs/product-decisions.md)
- [Measured economics](docs/model.md)
- [Operations](docs/operations.md)
- [Riddle pack](docs/riddle-pack.md)
- [Earlier handoff](GPT6_HANDOFF.md)

The snapshot preserves evidence; it does not migrate any balances, commitments,
assets, permissions or outstanding liabilities.
