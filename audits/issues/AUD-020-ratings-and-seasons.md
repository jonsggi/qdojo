...
- [x] Re-measure spread after AUD-014: the spread is stable, not widening (20,000 ticks: range 596 before, 613 after; drift 6–9 points per 1,000 ticks in the last third). Most common ranked pair 5.4% → 3.2% of ranked fights. Seasons: before, S1 went to the third-rated fighter with the second-rated unqualified; after, both seasons went to the top-rated fighter with the top 3 qualified ([economics report](../../docs/economics-report.md)).
