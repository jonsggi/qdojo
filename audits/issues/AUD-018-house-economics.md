...
- [x] Re-run the economics including execution cost and choose tiers, rake and entry fees so the house at least breaks even per fight. `combat-economics.py` now includes the simulated fee model and a break-even table; the demo profile uses 5,000/20,000 QU tiers, 500 bps ranked rake, a 1,000 bps cup fee profile and tier-scaled duel stakes and cup entries. Demo arena, 10,000 ticks, same lineup and seed: house P&L per fight **−156.5 → +84.5 QU** (ranked +93.8, duel +53.9, cup −4.4 before halving sponsorship); see [economics report](../../docs/economics-report.md) for the 20,000-tick pair.
