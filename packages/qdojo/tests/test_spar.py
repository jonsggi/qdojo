...
def test_summarize_money_and_fighters(tmp_path):
    ...
    assert s["rounds"] == 2 and s["money"]["stakes_in"] == 3000 and s["money"]["payouts_out"] == 7000
    assert s["money"]["house_delta"] == -4000 and s["money"]["house_delta_ex_funding"] == -4000 and s["money"]["carry_now"] == 6000
